...
export const DEFAULT_CATEGORIES: Omit<Category, 'id' | 'userId' | 'createdAt'>[] = [
  { name: '食費', icon: '🍽️', color: '#F97316', isDefault: true },
  { name: '交通費', icon: '🚃', color: '#3B82F6', isDefault: true },
  { name: '娯楽費', icon: '🎮', color: '#8B5CF6', isDefault: true },
  { name: 'その他', icon: '📦', color: '#6B7280', isDefault: true },
  { name: '給料', icon: '💰', color: '#10B981', isDefault: true },
  { name: '臨時収入', icon: '🎁', color: '#EC4899', isDefault: true },
  { name: '副収入', icon: '💼', color: '#06B6D4', isDefault: true },
];